...
class DeleteLogRepository {
  ...
  Future<void> logDelete(String type, Map<String, dynamic> data) =>
      _db.into(_db.deleteLogs).insert(DeleteLogsCompanion.insert(
            type: type,
  ...
  Future<void> restoreTransaction(int deleteLogId) async {
    ...
    await _db.into(_db.transactions).insert(TransactionsCompanion.insert(
          ...
          transferWalletId:
              data['transferWalletId'] != null ? Value(data['transferWalletId'] as int) : const Value(null),
          categoryId:
              data['categoryId'] != null ? Value(data['categoryId'] as int) : const Value(null),
          title: data['title'] != null ? Value(data['title'] as String) : const Value(null),
          note: data['note'] != null ? Value(data['note'] as String) : const Value(null),
          tags: data['tags'] != null ? Value(data['tags'] as String) : const Value(null),
